...
'   * v1.0.11 (22/07/21)
'           - Added soft shadow to the ThumbTooltip
...
Public Event showThumbTooltip(ByRef ThumbTooltipText As String)

' Variable to hold 'ThumbTooltipEnable' property value
Private m_bThumbTooltipEnable As Boolean
' Variable to hold 'ThumbTooltipFont' property value
Private m_StdThumbTooltipFont As StdFont
' Variable to hold 'StyleThumbColor' property value
Private m_StyleThumbColor As OLE_COLOR
' Variable to hold 'StyleBackColor' property value
Private m_StyleBackColor As OLE_COLOR
' Variable to hold 'StyleCurveRadius' property value
...
Private Sub timHideTooltip_Timer()
    If (txtToolTip.Visible = True) Then
       If (m_bThumbPressed = False) Then txtToolTip.Visible = False
    Else
...
Dim c&, d&, p As POINTAPI, hx&, hy&, sTooltipText$
    ...
    RaiseEvent showThumbTooltip(sTooltipText)
    ...
    If (c <> d) Then
        ...
        'To add shadow (sadly only work inside VB6 IDE.On exe add too much space on top)
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    m_SinSmoothScrollFactor = FixDec(PropBag.ReadProperty("SmoothScrollFactor", 0.5))
